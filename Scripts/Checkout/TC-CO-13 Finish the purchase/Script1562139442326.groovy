...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_last-name'), 'Alesti ')

WebUI.setText(findTestObject('Page_Swag Labs/input_Checkout Your Information_postal-code'), '20230')
